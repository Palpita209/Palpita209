...
try {
    ...
    $checkTable = "SHOW TABLES LIKE 'suppliers'";
    ...
    if ($tableExists->num_rows === 0) {
        throw new Exception("The suppliers table does not exist in the database");
    }

    // Get table structure
    $query = "DESCRIBE suppliers";
    ...
    $sampleQuery = "SELECT * FROM suppliers LIMIT 1";
    ...
    error_log("Error in check_suppliers.php: " . $e->getMessage());
    echo json_encode([
        'success' => false, 
